      ...
      <div className="container mx-auto px-6 text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 w-full md:w-auto">
            ...
            <Link href="/contactUs">
              <button className="bg-gradient-to-r from-purple-400 to-blue-500 text-white px-6 py-2 rounded-full font-medium hover:bg-gradient-to-r hover:from-purple-500 hover:to-blue-600 transition duration-300 ease-in-out w-full sm:w-auto">
                Contact Us
              </button>
            </Link>
          </div>
