  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row justify-between items-center bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white p-6 md:p-16">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-start md:ml-8 px-6">
        <h1 className="text-4xl md:text-6xl font-bold">Video & Animation</h1>
        <h3 className="mt-4 text-lg md:text-xl text-gray-400">Video & Animation by Code Vibe Studios        </h3>
        <p className="mt-4 text-md md:text-lg text-gray-300 leading-relaxed">
        With Code Vibe Studios’ video and animation services, we bring your ideas to life through engaging visuals. Whether you need a promotional video, explainer animation, or social media content, we combine storytelling with dynamic visuals to create content that captures attention and delivers your message effectively. Let us help you create impactful video content that resonates.</p>
        {/* Contact button */}
        <Link href="/contactUs">
