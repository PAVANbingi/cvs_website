  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row justify-between items-center bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white p-6 md:p-16">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-start md:ml-8 px-6">
        <h1 className="text-4xl md:text-6xl font-bold">Online Training</h1>
        <h3 className="mt-4 text-lg md:text-xl text-gray-400">Online Training by Code Vibe Studios        </h3>
        <p className="mt-4 text-md md:text-lg text-gray-300 leading-relaxed">
        Code Vibe Studios provides online training programs that empower individuals and teams to upskill at their own pace. Our training solutions are designed by industry experts to foster growth and development. From webinars to self-paced courses, we offer a variety of learning opportunities that cater to the dynamic needs of modern professionals.
          </p>
        {/* Contact button */}
        <Link href="/contactUs">
