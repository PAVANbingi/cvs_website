  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row justify-between items-center bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white p-6 md:p-16">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-start md:ml-8 px-6">
        <h1 className="text-4xl md:text-6xl font-bold">Graphics & Design</h1>
        <h3 className="mt-4 text-lg md:text-xl text-gray-400">Graphics & Design by Code Vibe Studios
        </h3>
        <p className="mt-4 text-md md:text-lg text-gray-300 leading-relaxed">
        Code Vibe Studios delivers exceptional graphic and design services to elevate your brand&ldquo;s visual identity. Whether it&ldquo;s logo design, marketing collateral, or web visuals, our creative team ensures that your brand stands out with stunning designs that leave a lasting impression on your audience. We bring creativity and strategy together for powerful results.
           </p>
        {/* Contact button */}
        <Link href="/contactUs">
